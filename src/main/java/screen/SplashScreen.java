 ...
 */
    ...
    MobileElement versionTextView; // putted element with this xPath to link versionTextView

    public String getCurrentVersion(){
        return versionTextView.getText();
    }

    public AuthentificationScreen goToAuthentificationScreen(){ //method that send us to next screen
